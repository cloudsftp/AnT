 ...
 *
 * $Id: RecurrentMapSimulator.cpp,v 1.3 2005/05/04 13:50:54 grosser Exp $
 *
 */
...
initDynamicalSystem (Configuration& dynSysDescription)
{
  ...
  */
  dynSysIterator = 
    new MapIterator (*(static_cast<RecurrentMapProxy*>(proxy)));
}
