 ...
 *
 * $Id: window2d.h,v 1.4 2004/02/27 21:24:22 wackengg Exp $
 *
 */
...
class TWindow2D:public TWindow
{
protected:
  virtual void draw ();
public:
  ...
  TWindow2D (const string& caption, int left, int top, int width, int height);
